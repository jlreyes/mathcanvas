...
exports.users.getById = function(id, callback) {
    ...
    multi.get("users." + id + ".rooms", function(e, res) {
        if (util.exists(e)) throw e;
        if (user === null) return;
        var rooms = {};
...
exports.rooms.getRooms = function(callback) {
    client.get("globals.rooms", function(e, res) {
        if (util.exists(e)) throw e;
        if (res === null) res = {};
        callback(res);
    });
...
exports.rooms.getPermittedUsers = function(id, callback) {
    client.get("rooms." + id + ".permittedUsers", function(e, res) {
        if (util.exists(e)) throw e;
        callback(res);
    });
};
...
exports.rooms.getRoom = function(id, callback) {
    ...
    multi.get("rooms." + room.id + ".users", function(e, res) {
        if (!util.exists(res)) res = {};
        room.users = res;
    });
    multi.exec(function(e, res) {
        if (util.exists(e)) throw e;
